...
const SignIn = () => {
  ...
  const { Login, resetPassword, signInWithGoogle, signInWithGithub } =
      ...
      <div className="flex justify-center items-center pt-4 pb-12">
        <div className="flex flex-col max-w-md p-4 rounded-md sm:p-10 bg-gray-100 text-gray-900">
          <div className="mb-4 text-center">
            <h1 className=" my-2 text-4xl font-bold">SignIn</h1>
          ...
          >
            ...
            <div className="space-y-2">
              <div>
                <button
                  type="submit"
                  className="w-full px-8 py-3 font-semibold rounded-md bg-gray-900 hover:bg-teal-400 hover:text-white text-gray-100"
                >
                  Sign In
                </button>
              </div>
          ...
          <p className="px-6 text-sm text-center text-gray-400">
            ...
            <NavLink to="/signup" className="hover:underline text-gray-600">
              Sign up
            </NavLink>
            .
          </p>
