...
const SingleCourse = ({ course }) => {
  return (
    <div className="">
      <div className=" bg-gray-400 flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md mt-2 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div>
          <img
            ...
            alt=""
            className="object-cover w-full h-48 mb-4  dark:bg-gray-500"
          />
