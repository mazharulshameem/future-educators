  ...
  return (
    <div className="bg-purple-600">
      <div className="flex justify-center items-center pt-4 pb-12">
        <div className="flex flex-col max-w-md p-4 rounded-md sm:p-10 shadow-xl bg-gray-100 text-gray-900">
          <div className="mb-4 text-center">
            <h1 className="my-2 text-4xl font-bold">Sign up Now !!</h1>
          ...
          >
            ...
            <div className="space-y-2">
              <div>
                <button
                  type="submit"
                  className="w-full px-8 py-3 font-semibold rounded-md bg-gray-900 hover:bg-teal-500 hover:text-white text-gray-100"
                >
                  Sign Up
                </button>
              </div>
          ...
          <div className="flex justify-center space-x-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 32 32"
                className="w-5 h-5 fill-current text-red-400 hover:text-teal-400"
              >
          ...
          <p className="px-6 text-sm text-center text-gray-400">
            ...
            <NavLink to="/signin" className="hover:underline text-purple-600">
              Sign In
            </NavLink>
            .
          </p>
